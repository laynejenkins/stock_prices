...
VIRTUAL_TWILIO_NUMBER = "example Virtual twilio number"
VERIFIED_NUMBER = "Personal phone number (verified with Twilio)"
...
# Find the positive difference and determine if stocks went up or down
